...
const Works = () => {
    return (
        <div className='w-11/12 mx-auto'>
            <h1 className='font-semibold text-primary my-6 text-5xl'>My recent works</h1>

            <div className='grid md:grid-cols-3 grid-cols-1 my-10 gap-10' >
                {/* project 1 */}
                <div class="card bg-[#081c24d6] shadow-xl">
                    <figure class="px-5 pt-5">
                        <img src="https://i.ibb.co/Dz1pJ7D/Screenshot-3.png" alt="Shoes" class="rounded-xl" />
                    </figure>
                    <div class="card-body items-center text-center">
                        <h2 class="card-title text-primary">Square Electronics</h2>
                        <div className='flex gap-2 flex-wrap'>
                            <button className='btn btn-xs btn-secondary'>React-router</button>
                            <button className='btn btn-xs btn-secondary'>Tialwind</button>
                            <button className='btn btn-xs btn-secondary'>DaisyUi</button>
                            <button className='btn btn-xs btn-secondary'>Firebase</button>
                            <button className='btn btn-xs btn-secondary'>MERN</button>
                        </div>
                ...
                <div class="card bg-[#081c24d6] shadow-xl">
                    <figure class="px-5 pt-5">
                        <img src="https://i.ibb.co/ZVrkcfv/Screenshot-1.png" alt="Shoes" class="rounded-xl" />
                    </figure>
                    <div class="card-body items-center text-center">
                ...
                <div class="card bg-[#081c24d6] shadow-xl">
                    ...
                    <div class="card-body items-center text-center">
                        ...
                        <div className='flex gap-2 flex-wrap'>
                            <button className='btn btn-xs btn-secondary'>React.js</button>
                            <button className='btn btn-xs btn-secondary'>Firebase</button>
                            <button className='btn btn-xs btn-secondary'>React-router</button>
                            <button className='btn btn-xs btn-secondary'>Tialwind</button>
                            <button className='btn btn-xs btn-secondary'>DaisyUi</button>
